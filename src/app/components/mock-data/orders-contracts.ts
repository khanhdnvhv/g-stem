...
export const contracts: Contract[] = Array.from({ length: 15 }, (_, i) => {
  ...
  return {
    ...
    milestones: [
      ...
      { title: "Thanh toán đợt 2 (40%)", dueAt: new Date(Date.parse(signedAt) + 30 * 86400_000).toISOString(), done: i % 3 !== 0 },
      { title: "Nghiệm thu kỹ thuật",    dueAt: new Date(Date.parse(signedAt) + 45 * 86400_000).toISOString(), done: i % 2 === 0 },
      { title: "Thanh toán đợt cuối (30%)", dueAt: new Date(Date.parse(signedAt) + 60 * 86400_000).toISOString(), done: i % 5 === 0 },
    ],
