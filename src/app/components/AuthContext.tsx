...
export const demoAccounts: AuthUser[] = [
  ...
  },
  {
    id: "U-STU-MN",
    name: "Bé Ngọc Linh",
    email: "mamnon@truonghoadung.edu.vn",
    password: "stem@123",
    avatar: "",
    tenantId: "T-SCH-02",
    tenantName: "Trường MN Hoa Đồng Nội",
    tenantType: "school",
    role: "student",
    legacyRole: "learner",
    position: "Học sinh Mầm non — Lớp Lá",
    initials: "NL",
    province: "Hà Nội",
    district: "Hoàng Mai",
    gradeLevel: "Mầm non",
  },
  {
    id: "U-STU-TH",
    name: "Trần Minh An",
    email: "tieuhoc@truonghoadung.edu.vn",
    password: "stem@123",
    avatar: "",
    tenantId: "T-SCH-02",
    tenantName: "Trường TH Hoa Đồng Nội",
    tenantType: "school",
    role: "student",
    legacyRole: "learner",
    position: "Học sinh — Lớp 3A",
    initials: "MA",
    province: "Hà Nội",
    district: "Hoàng Mai",
    gradeLevel: "Tiểu học 3",
  },
  {
    id: "U-STU-THPT",
    name: "Nguyễn Thị Mai",
    email: "thpt@thpttranphu.edu.vn",
    password: "stem@123",
    avatar: "",
    tenantId: "T-SCH-03",
    tenantName: "Trường THPT Trần Phú",
    tenantType: "school",
    role: "student",
    legacyRole: "learner",
    position: "Học sinh — Lớp 12A1",
    initials: "NM",
    province: "Hà Nội",
    district: "Hoàn Kiếm",
    gradeLevel: "THPT 12",
  ...
  },
  {
    ...
    legacyRole: "admin",
    position: "Cán bộ Phòng Giáo dục Mầm non",
    initials: "TN",
    province: "Hà Nội",
    vneidVerified: true,
  },
